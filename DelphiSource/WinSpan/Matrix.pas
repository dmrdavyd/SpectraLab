...
type
{ $IFOPT N+
  fndtype=array[0..maxp] of double;
  type mtype=array[0..maxp,1..maxp+1] of double;
  type partype=array[1..maxp] of double;
$ELSE }
  fndtype=array[0..maxp] of real;
  type mtype=array[0..maxp,1..maxp+1] of real;
  type partype=array[1..maxp] of real;
{ $ENDIF }
